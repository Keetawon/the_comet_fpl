...
make their static data private. Buy Me a Coffee links to the owner-provided
`https://buymeacoffee.com/thecomet` in a new tab with `noopener noreferrer`; no embedded payment
widget or third-party script is needed.
