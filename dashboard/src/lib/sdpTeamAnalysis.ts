...
export const teamMetricGroups = [
  ...
  { id: "attack", label: "Attacking", description: "Shot volume, chance quality and activity around the box.", keys: ["goals", "open_play_goals", "set_piece_goals", "expected_goals", "expected_goals_on_target", "shots", "shots_on_target", "shots_inside_box", "shots_outside_box", "shots_blocked", "big_chances_created", "big_chances_scored", "big_chances_missed", "touches_in_opposition_box"] },
